...
public class Tree implements Serializable {
    ...
    private final int SEED_WATER_NEED = 40; //TODO: 400/24
    private final int SEED_SUN_NEED = 40; // need per hour //TODO: 400/24
    private final int SEED_WATER_INTAKE = 200; // intake per kilometer
    private final int SEED_SUN_INTAKE = 100; // intake per kilometer
    private final int SEED_NEXT_PHASE = 5; // number of km where SEED goes into next phase TODO: 10
    ...
    private final int SPROUT_WATER_NEED = 40; // need per hour TODO:600 / 24
    private final int SPROUT_SUN_NEED = 40; // need per hour TODO:600 / 24
    ...
    private final int SPROUT_NEXT_PHASE = 10; // number of km where SPROUT goes into next phase TODO: 30
    ...
    private final int SAPLING_WATER_NEED = 40; // need per hour TODO: 800 / 24
    private final int SAPLING_SUN_NEED = 40; // need per hour TODO: 800 / 24
    ...
    private final int SAPLING_NEXT_PHASE = 15; // number of km where SAPLING goes into next phase TODO: 60
    ...
    private final int GROWN_TREE_WATER_NEED = 40; // need per hour TODO: 1000 / 24
    private final int GROWN_TREE_SUN_NEED = 40; // need per hour TODO: 1000 / 24
