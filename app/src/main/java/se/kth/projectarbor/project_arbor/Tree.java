...
public class Tree implements Serializable {
    ...
    private final int SEED_WATER_NEED = 100; // need per hour
    private final int SEED_SUN_NEED = 100; // need per hour
    private final int SEED_WATER_INTAKE = 100; // intake per kilometer
    ...
    private final int SPROUT_WATER_NEED = 100; // need per hour
    private final int SPROUT_SUN_NEED = 100; // need per hour
    private final int SPROUT_WATER_INTAKE = 100; // intake per kilometer
    private final int SPROUT_SUN_INTAKE = 100; // intake per kilometer
    ...
    private final int SAPLING_WATER_NEED = 100; // need per hour
    private final int SAPLING_SUN_NEED = 100; // need per hour
    private final int SAPLING_WATER_INTAKE = 100; // intake per kilometer
    private final int SAPLING_SUN_INTAKE = 100; // intake per kilometer
    ...
    private final int GROWN_TREE_WATER_NEED = 100; // need per hour
    private final int GROWN_TREE_SUN_NEED = 100; // need per hour
    private final int GROWN_TREE_WATER_INTAKE = 100; // intake per kilometer
    private final int GROWN_TREE_SUN_INTAKE = 100; // intake per kilometer
